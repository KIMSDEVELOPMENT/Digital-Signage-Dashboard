...
/**
 * GET /api/config/branches-locations
 * Returns all active branches with their locations.
 * Used by the frontend AuthContext to populate the branch/location selectors.
 */
