            ...
            <div className="glass-panel p-6 rounded-2xl border border-slate-800/40 space-y-4">
              ...
              <div className="p-4 rounded-xl bg-slate-900/50 border border-slate-800/40 text-xs text-slate-400 space-y-2 leading-relaxed">
                ...
                <ul className="list-disc pl-4 space-y-1">
                  <li>Must contain exact columns in order: <code className="text-[10px] text-emerald-400 px-1 bg-emerald-400/5 border border-emerald-500/10 rounded">Date, Site Name, Block Name, Department Name, Doctor Name</code></li>
